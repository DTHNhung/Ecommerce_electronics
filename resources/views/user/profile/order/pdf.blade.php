...
<body>
    <div style="margin-left:300pt;">
        <b>Date: </b> {{ $date_export->formatLocalized('%A %d %B %Y') }}<br />
    </div>
    <div class="col-span-9 shadow rounded px-6 pt-5 pb-7 mt-6 lg:mt-0 bg-white">
        <h1 class="text-3xl font-medium mb-6 mx-6 pt-3.5 pb-8 border border-l-0 border-t-0 
        ...
        <h3 class="text-lg font-medium mb-6 mx-2 pt-1 pb-4  uppercase text-center">
            {{ __('titles.order') }}: <span class="uppercase">{{ $order->code }} </span>
        </h3>
    ...
    <div class="text-lg py-2 text-gray-900">
        ...
        <span class="font-semibold">{{ $order->shipping->address }}</span>
    </div>
    </div>
    <div class="px-6 py-4 whitespace-nowrap">
        <div class="text-lg py-2 text-gray-900">
        ...
        <div class="text-lg py-2 text-gray-900">
            ...
            <span class="font-semibold">{{ formatDate($order->updated_at) }}</span>
        </div>
        @endif
        <div class="text-lg py-2 text-gray-900">
            {{ __('titles.status') }}:
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full" src="{{ asset('images/uploads/products/' . $product->image_thumbnail) }}" alt="">
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-mono uppercase font-semibold text-gray-900">
                                                {{ $product->name }}
                                            </div>
                                        </div>
                                    </div>
